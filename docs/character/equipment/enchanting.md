...
- Gain +1/2/3/4/5 Hit Power (add this number to each damage die) when casting spells with the implement.
- Once per short rest per rank, you may Empower a spell, adding +100% damage.
- At rank 2, you may choose to Doublecast, which uses an Empower charge to instead cast a second spell as a free action, immediately after a normal spellcasting action.
- At rank 3, your spell damage rolls always have advantage.
- At rank 4, tbd
- At rank 5, tbd
...
- Gain +1/2/3/4/5 to Hit and spell DC.
- The implement can hold concentration for you, acting like a normal concentration effect, but not using your concentration. If you take damage, you don't have to roll a concentration check, although if the implement itself takes damage, you do.
- At rank 2, you can quicken a defense, enhancement, mobility, summoning, healing, or utility spell once per short rest, making it a free action.
- At rank 3, you can designate a specific trigger (such as "I suffer more than 5 damage" or "an enemy casts a harmful spell at me or an ally"), under which a single chosen spell will automatically be cast as an immediate action to counter it.
- Rank 4/5 tbd
...
- Gain +1 critical threat range and +50% critical damage per rank.
- You may absorb the implement into yourself, gaining its power without needing to wield it in your hand. Also, when you strike a foe against whom you have Combat Advantage, you inflict critical bonus damage.
- At rank 2, you need not use somatic components to cast.
- At rank 3, you need not use verbal components to cast.
