...
rank: 1
type: Assault, Control
brief: Zap enemies with electricity, control the flow of magnetism
compact: at-will, swift; build a static charge, which causes heavy lightning damage on next contact with an enemy. Or, at-will, swift; ferric object repels or attracts ferric objects within 1 square. Or at-will, std, ranged; heavy lightning damage, or no damage plus stunned 1 rd (Con neg). At rank 2, Lightning strike can chain to 1 target + prof bonus when expending 1 Focus; or, reserve 1 Focus to activate Static Charge as a free action once/rd. At rank 3, lightning damage causes 100% vulnerability to lightning damage (non-stacking).
---
