...
school: Winter
rank: 0
type: Assault, debilitation, utility
brief: Draw Vitae from the environment or a creature, making them cold
---
...
Or, at-will, std, touch; you draw Vitae from a creature, dealing medium cold damage plus [chilled](../conditions/chilled) (Con ends). This grants you 1 Vitae per Witch rank.

At rank 2, you can create a large object, or a wall of ice up to 1 square long per proficiency bonus, with HP equal to a heavy damage roll, which lasts as long as you concentrate. Also, your cold damage increases to heavy, and the target is [rooted](../conditions/rooted) (Con ends, replaced with chilled, Con ends).

At rank 3, you can create a huge object, or a wall of ice up to 2 squares long per proficiency bonus. Also, when targeting a creature, they are [frozen](../conditions/frozen) (Con ends, replaced with rooted, Con ends); the ice block's HP equals a heavy damage roll.

Talents:
- Icy Grasp: you can use the touch version of the power at range.
- Chill Aura: at-will, std, close burst 2+1/rank; you gain 1 Vitae per rank, and the air becomes so cold that enemies in the area take light cold damage and are chilled (Con ends) at the start of their turn.
- Frostwright: the objects you create are magically imbued and more powerful than mundane ice.
...
Broken wall segments regenerate, regaining 50% of max HP at the start of your turn if not shattered. If shattered, they do not regenerate for the first round, but begin to regenerate normally after that. If a subject is rooted or frozen in that square, they become incorporated into the wall, suffering the [frozen](../conditions/frozen) condition until that wall segment is shattered again.
