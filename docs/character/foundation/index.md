...
When you create a character, they gain 3 Foundation "levels". Mostly this just means they gain 3 [Feats](../feats/) from Ancestry or Background. These levels do not include class levels or hit dice.



Ideas:
- Disposition Feats: blessed by a God, born under a Sign, marked by a Mark, etc.
- Equipment Feats: Item of Legacy, Inheritance, etc.
